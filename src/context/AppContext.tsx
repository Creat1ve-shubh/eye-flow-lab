...
const MOCK_HISTORY: TestResult[] = [
  {
    ...
    date: '3/15/2026',
    results: [
      { eye: 'left', lastCorrectRow: 7, acuity: '20/25', correctRows: [1,2,3,4,5,6,7], avgResponseTimeMs: 2800 },
      { eye: 'right', lastCorrectRow: 8, acuity: '20/20', correctRows: [1,2,3,4,5,6,7,8], avgResponseTimeMs: 2400 },
      { eye: 'both', lastCorrectRow: 9, acuity: '20/15', correctRows: [1,2,3,4,5,6,7,8,9], avgResponseTimeMs: 2100 },
    ],
    overallAcuity: '20/15',
    patientName: 'Arjun Mehta',
    patientDetails: { name: 'Arjun Mehta', age: 28, gender: 'male', hasGlasses: true, hasDiabetes: false, hasHypertension: false, familyHistoryEyeDisease: false, screenTimeHours: 8, lastEyeExam: 'less_than_1_year' },
  ...
  },
  {
    ...
    date: '2/28/2026',
    results: [
      { eye: 'left', lastCorrectRow: 6, acuity: '20/30', correctRows: [1,2,3,4,5,6], avgResponseTimeMs: 3200 },
      { eye: 'right', lastCorrectRow: 6, acuity: '20/30', correctRows: [1,2,3,4,5,6], avgResponseTimeMs: 3500 },
      { eye: 'both', lastCorrectRow: 7, acuity: '20/25', correctRows: [1,2,3,4,5,6,7], avgResponseTimeMs: 2900 },
    ],
    overallAcuity: '20/25',
    patientName: 'Priya Sharma',
    patientDetails: { name: 'Priya Sharma', age: 45, gender: 'female', hasGlasses: false, hasDiabetes: true, hasHypertension: true, familyHistoryEyeDisease: true, screenTimeHours: 6, lastEyeExam: '1_to_2_years' },
    totalDurationMs: 220000,
  },
  {
    id: '1003',
    date: '1/10/2026',
    results: [
      { eye: 'left', lastCorrectRow: 4, acuity: '20/50', correctRows: [1,2,3,4], avgResponseTimeMs: 4100 },
      { eye: 'right', lastCorrectRow: 5, acuity: '20/40', correctRows: [1,2,3,4,5], avgResponseTimeMs: 3800 },
    ],
    overallAcuity: '20/40',
    patientName: 'Rahul Verma',
    patientDetails: { name: 'Rahul Verma', age: 62, gender: 'male', hasGlasses: true, hasDiabetes: false, hasHypertension: true, familyHistoryEyeDisease: false, screenTimeHours: 3, lastEyeExam: 'more_than_2_years' },
  ...
  },
  {
    ...
    date: '12/5/2025',
    results: [
      { eye: 'both', lastCorrectRow: 8, acuity: '20/20', correctRows: [1,2,3,4,5,6,7,8], avgResponseTimeMs: 2600 },
    ],
    overallAcuity: '20/20',
    patientName: 'Sneha Reddy',
    patientDetails: { name: 'Sneha Reddy', age: 19, gender: 'female', hasGlasses: false, hasDiabetes: false, hasHypertension: false, familyHistoryEyeDisease: false, screenTimeHours: 10, lastEyeExam: 'never' },
